    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <form action="/user/getUserLoginCheck" method="post">
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-xl" name= "user_id" placeholder="Username" required>
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class="text-gray-600">늘봄 계정이 없으신가요?<a href="UserRegForm1"
                                                                       class="font-bold">Sign
                        up</a>.</p>
                    <p><a class="font-bold" href="ForgetPasswordForm">Forgot password?</a>.</p>
                </div>
            </div>
        </div>

...
<div id="">
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            ...
            <div class="container">
                <br>
                <h4>고객들이 보낸 메시지를 확인해 보세요!</h4>
                <h6>고객 아이디 뒤에는 담당자님 소속 기관명이 표시됩니다.</h6>
                <br>
                <div class="row card-body gnb">
                    <div class="col-4"><h5>고객 아이디</h5></div>
                    <hr/>
...
<%--                                    <button class="btn btn-secondary buttons" href="/chat/room?roomId=<%=roomId%>">채팅하기</button>--%>
